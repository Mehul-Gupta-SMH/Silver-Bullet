...
| 2026-05-08 | [x] | TRAIN v5.8: CVG (21F) best val 0.1712 @ ep20, stop ep35; RVG (22F) best val 0.1099 @ ep39; MVM (23F) best val 0.1275 @ ep18, stop ep33 | `train_cvg_v58.log`, `train_rvg_v58.log`, `train_mvm_v58.log` |
| 2026-05-08 | [x] | TEST v5.8: CVG 0.8130 (+0.0077), RVG 0.9283 (+0.0282), MVM 0.8969 (+0.0050) — all 3 modes improved vs v5.7 | `test_cvg_v58.log`, `test_rvg_v58.log`, `test_mvm_v58.log` |
